        ...
        parameters: {
            ...
            properties: {
                query: {
                    type: 'string',
                    description:
                        'Поисковый запрос — название услуги или частичное совпадение. ' + 'Например: "ЭКО", "приём гинеколога", "спермограмма", "УЗИ"'
                },
                branch_ref1c_id: {
                    type: 'string',
        ...
        parameters: {
            ...
            properties: {
                doctor_name: {
                    type: 'string',
                    description:
                        'Имя, фамилия или специализация врача (ОБЯЗАТЕЛЬНО на русском языке, ' +
                        'даже если пациент пишет на казахском или английском — переведи сам). ' +
                        'Например: "Иванова", "гинеколог", "репродуктолог"'
                },
                branch_ref1c_id: {
                    type: 'string',
                    description: 'ID филиала в 1С (ref1cId) для поиска врача в конкретном филиале'
                },
                branch_name: {
                    type: 'string',
                    description: 'Название филиала (например, "IRM Алматы", "IRM Астана")'
