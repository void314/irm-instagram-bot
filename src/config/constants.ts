...
const env = createEnv({
    ...
    schema: {
        ...
        private: {
            ...
            LLM_MODEL: v.optional(v.string(), 'deepseek/deepseek-v4-flash'),
            INTENT_MODEL: v.optional(v.string(), 'mistralai/mistral-nemo'),
            SYNTHESIS_MODEL: v.optional(v.string(), 'deepseek/deepseek-v4-flash'),
            RAG_MODEL: v.optional(v.string(), 'openai/gpt-4o-mini'),
            TOOL_MODEL: v.optional(v.string(), 'mistralai/mistral-nemo'),
